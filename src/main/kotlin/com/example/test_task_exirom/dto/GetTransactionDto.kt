...
data class GetTransactionDto(val transactionId: Long, val cardNumber: String, val expiryDate: String, val cvv: String, val amount: Double, val currency: Currency,
